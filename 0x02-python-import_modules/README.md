...
**Solution:** [0-add.py](https://github.com/viktorkrill/holbertonschool-higher_level_programming/blob/master/0x02-python-import_modules/0-add.py)
...
**Solution:** [1-calculation.py](https://github.com/viktorkrill/holbertonschool-higher_level_programming/blob/master/0x02-python-import_modules/1-calculation.py)
...
**Solution:** [2-args.py](https://github.com/viktorkrill/holbertonschool-higher_level_programming/blob/master/0x02-python-import_modules/2-args.py)
...
**Solution:** [3-infinite_add.py](https://github.com/viktorkrill/holbertonschool-higher_level_programming/blob/master/0x02-python-import_modules/3-infinite_add.py)
...
**Solution:** [4-hidden_discovery.py](https://github.com/viktorkrill/holbertonschool-higher_level_programming/blob/master/0x02-python-import_modules/4-hidden_discovery.py)
...
**Solution:** [5-variable_load.py](https://github.com/viktorkrill/holbertonschool-higher_level_programming/blob/master/0x02-python-import_modules/5-variable_load.py)
